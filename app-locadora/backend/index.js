...
app.post('/api/locacao', async (req, res) => {
  ...
  try {
    ...
    const serviceBusConnection = "Endpoint=sb://sb-dev-eastus-sintetico001.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=**********************************"//await secretClient.getSecret("ServiceBusConnectionString");
